...
const Simulator = ({ setWaterLevel, selectedCrop }) => { // 🛑 ADD selectedCrop PROP HERE
    ...
    const saveSimulationData = async (results) => {
        ...
        // 🛑 CRITICAL: Data structure must match SensorDataRequest.java DTO
        const dataToSend = {
            ...
            // 🛑 USE CORRECT FIELD NAME and ACTUAL CROP from state
        ...
        try {
            ...
            // 🛑 CRITICAL: The endpoint is /api/data/save
                ...
                <div className="simulation-results">
                    ...
                    <div className="results-grid">
                        ...
                        <div className="result-item">
                            ...
                            <div className="result-value">{simulationResults.fertilizerAmount} {translate('units')}</div>
